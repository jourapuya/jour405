...
md_cities_percentiles |>
  summarize(violent_rate_2020_iqr = IQR(violent_rate_2020))
```

There are 10 cities above the 90th percentile. 

These results do not change my best story idea because my story dealt with one city by itself compared to the rest of the data, and it still stands out even with the IQR. Frederick is in the 22nd percentile, and most of the cites of or under that percentile have near 0 numbers anyway. 
