...
# I don't really fully understand what the "tidyverse" is. Is it some database that's frequently used across programs like R studio? 

# It also asked me if I wanted to change 'conflicts' to 'errors', which I'm not entirely sure what purpose it serves? The instructions just said to load tidyverse so I didn't want to touch anything else in case I messed something up.

# I also think that I loaded the CSV correctly, but I feel like maybe I messed up somewhere still, because even though I loaded it into RStudio, I don't really understand what to do with it now.
